...
})({"eONPx":[function(require,module,exports) {
"use strict";
...
async function checkAccount(login, password) {
    axios.post("http://localhost:5000/verify", {
        ...
        if (response.data["login_check"] == true && response.data["password_check"] == true) {
            ...
            loadPage();
        } else bad_login.textContent = "Błędne dane logowania";
...
},{"./../utils":"5By4s"}]},["eONPx","lgyI9"], "lgyI9", "parcelRequire1550")

//# sourceMappingURL=index.c82ed771.js.map
